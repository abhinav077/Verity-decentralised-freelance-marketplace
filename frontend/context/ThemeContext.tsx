...
const THEMES: Record<ThemeName, ThemeColors> = {
  ...
  sunset: {
    pageBg: "#F4A261", pageFg: "#2D1208",
    cardBg: "#FDDBB4", cardBorder: "#EBA07A", cardHoverBorder: "#E76F51",
    surfaceBg: "#F9C9A0",
    navBg: "#F4A261", navBorder: "#EBA07A", navText: "#3D1A0A",
    primary: "#E76F51", primaryHover: "#D4553A", primaryLight: "#F8D5CE",
    primaryText: "#FFFFFF", primaryFg: "#E76F51",
    muted: "#C4845A", mutedFg: "#7A4A2A",
    inputBg: "#FEE8CC", inputBorder: "#EBA07A", inputFocus: "#E76F51",
    divider: "#EBA07A",
  ...
  forest: {
    pageBg: "#C8E6C9", pageFg: "#0D3B1F",
    cardBg: "#FFFFFF", cardBorder: "#A5D6A7", cardHoverBorder: "#2E7D32",
    surfaceBg: "#E8F5E9",
    navBg: "#C8E6C9", navBorder: "#A5D6A7", navText: "#1B5E20",
    primary: "#2E7D32", primaryHover: "#1B5E20", primaryLight: "#E8F5E9",
    primaryText: "#FFFFFF", primaryFg: "#1B5E20",
    muted: "#81C784", mutedFg: "#388E3C",
    inputBg: "#FFFFFF", inputBorder: "#A5D6A7", inputFocus: "#2E7D32",
    divider: "#A5D6A7",
  ...
  rose: {
    pageBg: "#FCE4EC", pageFg: "#880E4F",
    cardBg: "#FFFFFF", cardBorder: "#F8BBD0", cardHoverBorder: "#E91E63",
    surfaceBg: "#FFF0F5",
    navBg: "#FCE4EC", navBorder: "#F8BBD0", navText: "#880E4F",
    primary: "#E91E63", primaryHover: "#C2185B", primaryLight: "#FFF0F5",
    primaryText: "#FFFFFF", primaryFg: "#C2185B",
    muted: "#F48FB1", mutedFg: "#AD1457",
    inputBg: "#FFFFFF", inputBorder: "#F8BBD0", inputFocus: "#E91E63",
    divider: "#F8BBD0",
