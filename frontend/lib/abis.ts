...
export const GOVERNANCE_ABI = [
  ...
  // Crowdfunding
  "function createCrowdfundProject(string title, string description, string category, string proofLink, uint256 goalAmount, uint256 durationDays) external returns (uint256)",
