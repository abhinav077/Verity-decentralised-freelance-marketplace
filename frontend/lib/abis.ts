...
const LOAN_TUPLE = "tuple(uint256 id, address borrower, uint256 amount, uint256 collateral, uint256 repaid, uint256 createdAt, uint256 expiresAt, bool settled, bool defaulted)";

export const REPUTATION_LOANS_ABI = [
  ...
  "function COLLATERAL_PER_10_VRT() view returns (uint256)",
  // Admin setters
  "function setMaxLoanAmount(uint256 _m) external",
  "function setLoanDuration(uint256 _d) external",
  "function setCollateralPer10Vrt(uint256 _c) external",
  "function hasDefaulted(address user) view returns (bool)",
  "function takeLoan(uint256 amount) external payable returns (uint256)",
  "function repayLoan(uint256 amount) external",
  "function markDefault(uint256 loanId) external",
  "function withdrawForfeitedCollateral() external",
  `function getLoan(uint256 id) view returns (${LOAN_TUPLE})`,
  `function getUserLoans(address user) view returns (${LOAN_TUPLE}[])`,
  `function getActiveLoan(address user) view returns (${LOAN_TUPLE})`,
...
const POLICY_TUPLE = "tuple(address freelancer, uint256 premium, uint256 coverage, uint256 createdAt, uint256 expiresAt, bool claimed, bool withdrawn)";
...
export const INSURANCE_POOL_ABI = [
  ...
  "function withdrawPremium(uint256 policyId) external",
  "function ADMIN_ROLE() view returns (bytes32)",
  "function hasRole(bytes32 role, address account) view returns (bool)",
  "function fundPool() external payable",
  `function getPolicy(uint256 id) view returns (${POLICY_TUPLE})`,
  `function getUserPolicies(address user) view returns (${POLICY_TUPLE}[])`,
  "function poolBalance() view returns (uint256)",
  "function policyCounter() view returns (uint256)",
  "function totalPoolBalance() view returns (uint256)",
  "function COVERAGE_MULTIPLIER() view returns (uint256)",
  "function POLICY_DURATION() view returns (uint256)",
  "function MIN_PREMIUM() view returns (uint256)",
  // Admin setters
  "function setCoverageMultiplier(uint256 _m) external",
  "function setPolicyDuration(uint256 _d) external",
  "function setMinPremium(uint256 _p) external",
